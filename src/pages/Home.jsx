...
// Displays the dashboard and manages dashboard navigation.
function Home({ user }) {
    ...
    return (
        <main className="dashboard-page">
            ...
            <aside className="dashboard-sidebar">
                ...
                {/* Displays the current user and logout button. */}
            ...
            <section className="dashboard-content">
                ...
                {/* Displays the welcome message and quick add button. */}
                ...
                {/* Displays today's fitness summary cards. */}
                <section className="stats-grid">

                    {/* Displays daily calorie progress. */}
                    <article
                        className="stat-card"
                        onClick={() =>
                            navigate("/calories")
                    ...
                    {/* Displays daily protein progress. */}
                    ...
                    {/* Displays current body weight progress. */}
                    <article className="stat-card">
                ...
                {/* Displays nutrition progress and the next workout. */}
                <section className="dashboard-main-grid">

                    {/* Displays calorie and macronutrient progress. */}
                    ...
                    {/* Displays information about the next workout session. */}
                    <article className="dashboard-panel">
                ...
                {/* Displays shortcuts for common tracking actions. */}
                <section className="quick-actions-section">
                    ...
                    <div className="quick-actions-grid">
                        ...
                        {/* Opens the workout tracking page. */}
                        <button
                            type="button"
                        ...
                        {/* Displays the food tracking shortcut. */}
                        <button
                            type="button"
                            className="action-card"
                        >
                        ...
                        {/* Opens the calorie calculator page. */}
                        <button
                            type="button"
                            className="action-card"
                            onClick={() =>
