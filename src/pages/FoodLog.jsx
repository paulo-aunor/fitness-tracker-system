        ...
        <section className="gym-food-library">
          <div className="gym-food-library-header">
            <div>
              ...
              <span>
                Can't find it above? Search the full Open Food Facts database.
              </span>
            </div>
          ...
          <p className="gym-food-disclaimer">
            Nutrition values come from Open Food Facts and are per 100g -- they
            may not match the exact serving you eat.
          </p>
        </section>
